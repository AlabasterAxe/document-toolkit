...
export class DocumentContentProcessor {
   ...
   */
  static createFootnoteProcessor(FootnoteComponent: React.ComponentType<any>) {
    return function processFootnotesWithComponent(htmlContent: string): React.ReactNode[] {
